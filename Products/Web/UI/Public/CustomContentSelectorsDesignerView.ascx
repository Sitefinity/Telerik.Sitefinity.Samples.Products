...
<div id="selectorTag" runat="server" style="display: none;">
   <designers:ContentSelector 
       ...
       TitleText="<%$Resources:ProductsResources, ChooseProduct %>" 
       BindOnLoad="false" 
...
<h2>
   <asp:Literal ID="choicesTitle" runat="server" Text="<%$Resources:ProductsResources, WhichProductsToDisplay %>" /></h2>
<ul class="sfRadioList">
   <li>
      <asp:RadioButton runat="server" ID="contentSelect_AllItems" Checked="true" GroupName="ContentSelection" Text="<%$Resources:ProductsResources, AllPublishedProducts %>" />
   </li>
   <li>
      <asp:RadioButton runat="server" ID="contentSelect_OneItem" GroupName="ContentSelection" Text="<%$Resources:ProductsResources, OneParticularProductsOnly %>" />
      <div class="sfExpandedPropertyDetails" id="selectorPanel" style="display:none"  >
         ...
         <span class="sfLinkBtn sfChange" runat="server" id="btnSelectSingleItemWrapper">
             <asp:LinkButton NavigateUrl="javascript:void(0)" runat="server" ID="btnSelectSingleItem" OnClientClick="return false;" CssClass="sfLinkBtnIn">
                <asp:Literal ID="btnSelectSingleItemLiteral" runat="server" Text="<%$Resources:ProductsResources, SelectProduct %>" />
             </asp:LinkButton>
         </span>
      </div>
   </li>
   <li>
      <asp:RadioButton runat="server" ID="contentSelect_SimpleFilter" GroupName="ContentSelection" Text="<%$Resources:ProductsResources, SelectionOfProducts %>" />
         ...
         <designers:FilterSelector ID="filterSelector" runat="server" AllowMultipleSelection="true" 
            ...
            <Items>
                ...
                <designers:FilterSelectorItem ID="FilterSelectorItem3" runat="server" Text="<%$Resources:Labels, ByDates %>"
                    ...
                    <SelectorResultView>
                        <sitefinity:DateRangeSelectorResultView ID="DateRangeSelectorResultView1" runat="server" SelectorDateRangesTitle="<%$Resources:ProductsResources, DisplayProductsPublishedIn %>">
